...
import { loadState, saveState, handleLogin, handleReconnection } from "./system.ts";
...
io.on("connection", (socket) => {
  ...
  handleEntities(socket, io, onlineUsers, entitiesState);
